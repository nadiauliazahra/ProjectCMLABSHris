                ...
                <div className={`flex-1 transition-all duration-500 ${showSummary ? 'lg:max-w-xl' : 'max-w-2xl mx-auto'}`}>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <button
                                ...
                                className={`flex-1 py-3 px-4 rounded-[5px] text-base font-medium transition-all duration-200 border-2 ${
                                    billingPeriod === "single"
                                        ? "bg-[#1D395E] text-white border-[#1D395E] shadow-md"
                                        : "bg-[#EDEDED] text-[#A7A7A7] border-[#D8DDE1] hover:border-[#1D395E]/30"
                                }`}
                            >
                                Single Payment
                            </button>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex gap-6">
                            ...
                            <input 
                                ...
                                onChange={() => handleTeamSizeChange("1-50")} 
                            />
                            ...
                            <input 
                                ...
                                onChange={() => handleTeamSizeChange("50-100")} 
                            />
                    ...
                    <div className="mb-10">
                        ...
                        <div className="flex items-center gap-4">
                            <button 
                                ...
                                className="w-8 h-8 rounded border-2 border-[#D8DDE1] flex items-center justify-center hover:bg-gray-100 text-black font-bold select-none active:bg-gray-200"
                            >
                                -
                            </button>
                            ...
                            <input 
                                ...
                                className="w-20 text-center text-xl font-medium text-black border-none focus:ring-0 focus:outline-none p-0 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                            />
                    ...
                    {!showSummary ? (
                        <button 
                            ...
                            className="w-full bg-[#B93B53] text-white py-4 rounded-lg font-semibold hover:bg-[#a12f45] transition-all transform hover:scale-[1.01] shadow-lg flex items-center justify-center gap-2"
                        >
                            Continue to Payment
                    ...
                    <div className="w-full lg:w-[450px] shrink-0 animate-in fade-in slide-in-from-right-8 duration-700 ease-out">
                        <div className="bg-gradient-to-bl from-[#102543] to-[#010D1C] text-white p-8 rounded-xl shadow-2xl sticky top-6">
                            ...
                            <div className="space-y-4 text-sm mb-6">
                                ...
                                <span className="text-gray-300 w-1/3">Package</span>
                                <span className="text-white flex-1">: {planName}</span>
                                </div>
                                <div className="flex justify-between">
                                <span className="text-gray-300 w-1/3">Billing Period</span>
                                <span className="text-white flex-1 capitalize">: {billingPeriod === 'single' ? 'Single Payment' : 'Monthly'}</span>
                                </div>
                                <div className="flex justify-between">
                                <span className="text-gray-300 w-1/3">Team Size</span>
                                <span className="text-white flex-1">: {teamSize}</span>
                                </div>
                                <div className="flex justify-between">
                                <span className="text-gray-300 w-1/3">Employees</span>
                                <span className="text-white flex-1">: {validEmployees}</span>
                                </div>
                                <div className="flex justify-between">
                                <span className="text-gray-300 w-1/3">Price per User</span>
                                <span className="text-white flex-1">: Rp {basePrice.toLocaleString('id-ID')}</span>
                                </div>
                            </div>
                            ...
                            <button className="w-full bg-[#1E3A5F]/50 border border-[#AFCBEA]/20 hover:bg-[#1E3A5F] text-white py-3 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2 group">
                                Confirm and Upgrade
                                <Icon icon="mdi:check-circle-outline" className="text-xl group-hover:text-green-400 transition-colors" />
                            </button>
                        </div>
                    </div>
                )}
